...
export default function GroupDetail({ id }) {
  ...
  useEffect(() => {
    fetch(`${import.meta.env.VITE_API_URL || ""}/api/group/${id}`)
  ...
  if (error)   return <div className="detail-loading">{error} <a href="/#group">← Go back</a></div>;
    ...
    <div className="page">
      ...
      <div className="detail-hero" style={{ backgroundImage: `url(${item.image})` }}>
        <div className="detail-hero-overlay">
          <div className="pill" style={{ marginBottom: 12 }}>Group Package</div>
        ...
        <aside className="detail-sidebar">
          <div className="detail-card">
            ...
            <div className="detail-info-row">
              ...
              <span className="detail-info-value">Group</span>
            </div>
      ...
      <footer className="footer">
        ...
        <div><a href="/#group" style={{ color: "var(--muted)" }}>← All Group Packages</a></div>
      </footer>
    </div>
  );
}
